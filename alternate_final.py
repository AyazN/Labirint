...
def play_alt(running, user_id, num_exit, total, num, dead, img_kill, img_fire, win, killing, pos_p, pos_e):
    pygame.init()
    ...
    player.pos_x, player.pos_y = pos_p
    enemy.pos_x, enemy.pos_y = pos_e
